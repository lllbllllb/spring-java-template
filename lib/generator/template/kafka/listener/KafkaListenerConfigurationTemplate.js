...
public class ${className} {
    ...
    ConsumerFactory<byte[], ${payloadClassName}> ${operationId}ConsumerFactory(
        ...
        var consumerProperties = new HashMap<>(kafkaProperties.buildConsumerProperties());
        consumerProperties.putAll(properties.buildProperties());
        consumerProperties.put(JacksonJsonDeserializer.VALUE_DEFAULT_TYPE, ${payloadClassName}.class.getName());
        consumerProperties.put(JacksonJsonDeserializer.TRUSTED_PACKAGES, ${payloadClassName}.class.getPackageName());
