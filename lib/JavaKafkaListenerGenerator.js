...
} from "./template/KafkaListenerConfigurationPropertiesTemplate";
import { KAFKA_LISTENER_CONFIGURATION_TEMPLATE } from "./template/KafkaListenerConfigurationTemplate";
import { KAFKA_MESSAGE_LISTENER_TEMPLATE } from "./template/KafkaMessageListenerTemplate";
...
export class JavaKafkaListenerGenerator {
    ...
    renderKafkaMessageListener(channel) {
        ...
        const className = `${upperOperationId}KafkaMessageListenerService`;
